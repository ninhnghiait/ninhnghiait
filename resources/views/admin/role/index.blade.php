        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="{{ route('ad_roles.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> Add</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding">
              ...
              @slot('tableBody')
                ...
                $urlEdit = route('ad_roles.edit', $id);
                $urlDel = route('ad_roles.destroy', $id);
                @endphp
                <tr>
                  <td>{{ $id }}</td>
                  <td>{{ $name }}</td>
