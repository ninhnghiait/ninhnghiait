      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{ route('ad_users.store') }}" method="post" enctype="multipart/form-data">
              <div class="box-body">
                  @csrf
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-nc">
                        <label>Email</label>
                        <div class="form-group input-group">
                          <input name="email" value="{{ old('email') }}" type="email" class="form-control" style="width: 100%;">
                      ...
                      <div class="form-group">
                        ...
                        <option value="{{ $group['id'] }}" {{ in_array($group['id'], $oldGroup) ? 'selected' : '' }}>{{ $group['name'] }}</option>
                        @endforeach
                        </select>
                      ...
                      <div class="form-group">
                        <label>Active</label> &nbsp;&nbsp;
                        <input type="checkbox" name="activefr" class="minimal" {{ old('activefr') == null ? '' : 'checked' }} >
                      </div>
                      <!-- /.form-group -->
                      <div class="form-nc">
                        <label>Avatar</label>
                        ...
                        <span class="nc-error"><i class="fa fa-times-circle-o"></i> {{ $errors->first('avatar') }}</span>
                        @endif
                      </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-md-6">
                      <div class="form-nc">
                        ...
                        <div class="form-group input-group">
                          <input name="fullname" value="{{ old('fullname') }}" type="text" class="form-control" style="width: 100%;">
                      ...
                      <div class="form-nc">
                        <label>Address</label>
                        <div class="form-group input-group">
                          <input name="address" value="{{ old('address') }}" type="text" class="form-control" style="width: 100%;">
                      ...
                      <div class="form-nc">
                        <label>Phone</label>
                        <div class="form-group input-group" style="width: 100%">
                          <input name="phone_number" value="{{ old('phone_number') }}" type="text" class="phone_number form-control" id="phone" style="width: 100%;">
                      ...
                      <!-- /.form-group -->
                      <div class="form-nc">
                        <img id="avatar" src="{{ asset('/storage/app/files/users/logo_default.png') }}" alt="" class="img-thumbnail" style="border-radius: 50%" width="35%">
                      </div>
                    </div>
                  </div>
              </div>
...
<script>
    ...
    iti.setCountry("{{ old('region_code') }}");
    @else
    iti.setCountry("vn");
    @endif
