...
<head>
  ...
  <title>NinhNghiaIt | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>N</b>It</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>NinhNghia</b>It</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('storage/app/files/users/'.$avatar) }}" class="user-image" alt="User Image">
...
<!-- Side-bar active -->
<script src="{{ asset('templates/admin/custom/active-side-bar.js') }}"></script>
@yield('footer')
